//==================================================================================================
///  @file R1TestResultDialog.h
///
///  Definition of the class R1TestResultDialog.
///
///  Copyright (C) 2014 Simba Technologies Incorporated.
//==================================================================================================

#ifndef _RYFTONE_R1RESULTDIALOG_H_
#define _RYFTONE_R1RESULTDIALOG_H_
...
namespace RyftOne
{
    ...
    class R1TestResultDialog : public R1BaseDialog
    {
    // Public ======================================================================================
    public:
        /// @brief Constructor.
        ...
        static bool Show(HWND in_parentWindow, R1DSNConfiguration& in_settings);
