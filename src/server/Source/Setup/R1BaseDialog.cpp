//==================================================================================================
///  @file R1BaseDialog.cpp
///
///  Implementation of the class R1BaseDialog.
///
...
// Public ==========================================================================================
////////////////////////////////////////////////////////////////////////////////////////////////////
void R1BaseDialog::ShowErrorDialog(HWND in_dialogHandle, const simba_wstring& in_errorMessage)
{
    CString title;
    R1ResourceHelper::LoadStringResource(IDS_CONFIG_ERROR_TITLE, title);
...
// Protected =======================================================================================
////////////////////////////////////////////////////////////////////////////////////////////////////
void R1BaseDialog::CenterDialog(HWND in_dialogHandle)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring R1BaseDialog::GetListText(
    HWND in_dialogHandle,
    simba_int32 in_component,
    simba_uint32 in_index)
{
    // Get the length of the selection.
    LRESR1T textLength = SendDlgItemMessage(
        in_dialogHandle, 
        in_component, 
        LB_GETTEXTLEN, 
        in_index, 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring R1BaseDialog::GetEditText(HWND in_dialogHandle, simba_int32 in_component)
{
    // Get the length of the selection.
    LRESR1T textLength = SendDlgItemMessage(
        in_dialogHandle, 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring R1BaseDialog::GetErrorMessage(ErrorException& in_exception)
{
    ...
    messageSource.RegisterMessages(ERROR_MESSAGES_FILE, R1_ERROR);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring R1BaseDialog::GetSelectedComboText(
    HWND in_dialogHandle, 
    simba_int32 in_component)
{
    // Get the selection at the current index in the dropdown.
    LRESR1T index = SendDlgItemMessage(in_dialogHandle, in_component, CB_GETCURSEL, 0, 0);
    if (CB_ERR == index)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void R1BaseDialog::SetCursorArrow()
{
    HCURSOR cursor = LoadCursor(NULL, IDC_ARROW);
    if (!cursor)
    {
        // Failed to load the cursor.
        R1THROWGEN1(L"R1CursorResourceError", GetLastErrorText());
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void R1BaseDialog::SetCursorHourglass()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void R1BaseDialog::SetIcon(HWND in_dialogHandle, simba_int32 in_component)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool R1BaseDialog::ShowChoiceDialog(
    HWND in_dialogHandle, 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void R1BaseDialog::ShowErrorDialog(HWND in_dialogHandle, ErrorException& in_exception)
{
