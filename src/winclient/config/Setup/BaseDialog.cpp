...
///  @file BaseDialog.cpp
///
///  Implementation of the class BaseDialog.
///
...
// Public ==========================================================================================
////////////////////////////////////////////////////////////////////////////////////////////////////
void BaseDialog::ShowErrorDialog(HWND in_dialogHandle, const simba_wstring& in_errorMessage)
{
    CString title;
    ResourceHelper::LoadStringResource(IDS_CONFIG_ERROR_TITLE, title);
...
// Protected =======================================================================================
////////////////////////////////////////////////////////////////////////////////////////////////////
void BaseDialog::CenterDialog(HWND in_dialogHandle)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring BaseDialog::GetListText(
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring BaseDialog::GetEditText(HWND in_dialogHandle, simba_int32 in_component)
{
    // Get the length of the selection.
    LRESULT textLength = SendDlgItemMessage(
        in_dialogHandle, 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring BaseDialog::GetErrorMessage(ErrorException& in_exception)
{
    ...
    messageSource.RegisterMessages(ERROR_MESSAGES_FILE, RYFT_ERROR);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
simba_wstring BaseDialog::GetSelectedComboText(
    HWND in_dialogHandle, 
    simba_int32 in_component)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void BaseDialog::SetCursorArrow()
{
    HCURSOR cursor = LoadCursor(NULL, IDC_ARROW);
    if (!cursor)
    {
        // Failed to load the cursor.
        RYFTTHROWGEN1(L"CursorResourceError", GetLastErrorText());
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void BaseDialog::SetCursorHourglass()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void BaseDialog::SetIcon(HWND in_dialogHandle, simba_int32 in_component)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool BaseDialog::ShowChoiceDialog(
    HWND in_dialogHandle, 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void BaseDialog::ShowErrorDialog(HWND in_dialogHandle, ErrorException& in_exception)
{
