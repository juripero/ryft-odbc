//==================================================================================================
///  @file SetupException.h
///
///  Definition of the Class SetupException.
///
///  Copyright (C) 2014 Simba Technologies Incorporated.
///  Copyright (C) 2015 Ryft Incorporated.
//==================================================================================================

#ifndef _RYFT_SETUPEXCEPTION_H_
#define _RYFT_SETUPEXCEPTION_H_
...
namespace Ryft
{
    ...
    public:
        ...
        SetupException(ErrorCode in_errorCode) : m_errorCode(in_errorCode) {}

        /// @brief Destructor.
        virtual ~SetupException() {}
