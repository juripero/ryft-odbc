// =================================================================================================
///  @file R1SchemaOnlyMetadataSource.h
///
///  Definition of the class R1SchemaOnlyMetadataSource
///
///  Copyright (C) 2005-2014 Simba Technologies Incorporated.
// =================================================================================================

#ifndef _RYFTONE_R1SCHEMAONLYMETADATASOURCE_H_
#define _RYFTONE_R1SCHEMAONLYMETADATASOURCE_H_
...
namespace RyftOne
{
    /// @brief RyftOne sample metadata table for schema metadata.
    ///
    ...
    class R1SchemaOnlyMetadataSource : public Simba::DSI::DSIMetadataSource
    {
    // Public ======================================================================================
    public:
        /// @brief Constructor.
        ...
        R1SchemaOnlyMetadataSource(Simba::DSI::DSIMetadataRestrictions& in_restrictions);

        /// @brief Destructor.
        virtual ~R1SchemaOnlyMetadataSource();
