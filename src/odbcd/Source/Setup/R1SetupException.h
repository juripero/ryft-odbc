//==================================================================================================
///  @file R1SetupException.h
///
///  Definition of the Class R1SetupException.
///
///  Copyright (C) 2014 Simba Technologies Incorporated.
//==================================================================================================

#ifndef _RYFTONE_R1SETUPEXCEPTION_H_
#define _RYFTONE_R1SETUPEXCEPTION_H_
...
namespace RyftOne
{
    ...
    public:
        ...
        R1SetupException(ErrorCode in_errorCode) : m_errorCode(in_errorCode) {}

        /// @brief Destructor.
        virtual ~R1SetupException() {}
